...
const PRODUCTS = [
  ...
  { id: "rui", category: "fish", name: "Rui Fish", nameBn: "রুই মাছ", farmer: "Abdur Rahim", farmerId: "rahim", district: "Mymensingh", price: 380, unit: "kg", rating: 4.6, reviews: 98, icon: "fish", desc: "Farm-raised Rui from clean pond water, cut to order.", descBn: "পরিষ্কার পুকুরের পানিতে চাষ করা রুই মাছ, অর্ডার অনুযায়ী কাটা হয়।" },
  { id: "katla", category: "fish", name: "Katla Fish", nameBn: "কাতলা মাছ", farmer: "Abdur Rahim", farmerId: "rahim", district: "Mymensingh", price: 350, unit: "kg", rating: 4.5, reviews: 76, icon: "fish", desc: "Firm, meaty Katla — a household favourite for curry.", descBn: "ঘন মাংসল কাতলা মাছ, তরকারির জন্য জনপ্রিয়।" },
  ...
  { id: "pangas", category: "fish", name: "Pangas Fish", nameBn: "পাঙাশ মাছ", farmer: "Fatema Begum", farmerId: "fatema", district: "Khulna", price: 220, unit: "kg", rating: 4.3, reviews: 61, icon: "fish", desc: "Boneless-friendly, budget-friendly everyday fish.", descBn: "সহজে রান্না করা যায় এমন সাশ্রয়ী মূল্যের মাছ।" },
  { id: "koi", category: "fish", name: "Koi Fish", nameBn: "কই মাছ", farmer: "Karim Mollah", farmerId: "karim", district: "Chandpur", price: 420, unit: "kg", rating: 4.4, reviews: 42, icon: "fish", desc: "Live-tank Koi, delivered same-day for maximum freshness.", descBn: "জীবন্ত কই মাছ, সর্বোচ্চ সতেজতার জন্য একই দিনে ডেলিভারি।" },
  ...
  { id: "mutton", category: "meat", name: "Khashi (Mutton)", nameBn: "খাসির মাংস", farmer: "Jasim Uddin", farmerId: "jasim", district: "Pabna", price: 1100, unit: "kg", rating: 4.8, reviews: 168, icon: "drumstick", halal: true, desc: "Tender khashi from free-range goats, aged for better flavour.", descBn: "উন্মুক্ত পরিবেশে পালিত খাসির নরম মাংস।" },
  { id: "buffalo", category: "meat", name: "Buffalo Meat", nameBn: "মহিষের মাংস", farmer: "Rafiqul Islam", farmerId: "rafiqul", district: "Bogura", price: 650, unit: "kg", rating: 4.4, reviews: 53, icon: "drumstick", halal: true, desc: "Lean buffalo meat, a great everyday alternative to beef.", descBn: "কম চর্বিযুক্ত মহিষের মাংস, প্রতিদিনের জন্য উপযোগী।" },
  ...
  { id: "broiler-chicken", category: "poultry", name: "Broiler Chicken", nameBn: "ব্রয়লার মুরগি", farmer: "Nasrin Akter", farmerId: "nasrin", district: "Gazipur", price: 210, unit: "kg", rating: 4.2, reviews: 132, icon: "drumstick", halal: true, desc: "Freshly processed broiler chicken, cleaned and cut to preference.", descBn: "সদ্য প্রক্রিয়াজাত ব্রয়লার মুরগি, পছন্দমতো কাটা।" },
  { id: "duck", category: "poultry", name: "Farm Duck", nameBn: "হাঁস", farmer: "Nasrin Akter", farmerId: "nasrin", district: "Gazipur", price: 480, unit: "kg", rating: 4.6, reviews: 39, icon: "drumstick", halal: true, desc: "Pond-raised duck, rich flavour, popular for winter bhuna.", descBn: "পুকুর পাড়ে পালিত হাঁস, শীতের ভুনার জন্য জনপ্রিয়।" },
  ...
  { id: "duck-egg", category: "poultry", name: "Duck Eggs (12pc)", nameBn: "হাঁসের ডিম (১২টি)", farmer: "Nasrin Akter", farmerId: "nasrin", district: "Gazipur", price: 190, unit: "dozen", rating: 4.5, reviews: 71, icon: "egg", desc: "Rich, creamy duck eggs great for bakes and curries.", descBn: "বেকিং ও তরকারির জন্য উপযুক্ত সমৃদ্ধ হাঁসের ডিম।" },

  { id: "tomato", category: "vegetables", name: "Tomato", nameBn: "টমেটো", farmer: "Rafiqul Islam", farmerId: "rafiqul", district: "Bogura", price: 55, unit: "kg", rating: 4.3, reviews: 87, icon: "carrot", desc: "Vine-ripened tomatoes picked the same morning.", descBn: "সকালেই তোলা পাকা টমেটো।" },
  ...
  { id: "eggplant", category: "vegetables", name: "Eggplant (Begun)", nameBn: "বেগুন", farmer: "Rafiqul Islam", farmerId: "rafiqul", district: "Bogura", price: 60, unit: "kg", rating: 4.2, reviews: 44, icon: "carrot", desc: "Glossy, firm eggplants perfect for bhorta or fry.", descBn: "ভর্তা বা ভাজির জন্য উপযুক্ত টাটকা বেগুন।" },
  { id: "pumpkin", category: "vegetables", name: "Sweet Pumpkin", nameBn: "মিষ্টি কুমড়া", farmer: "Hasina Khatun", farmerId: "hasina", district: "Rangpur", price: 40, unit: "kg", rating: 4.4, reviews: 33, icon: "carrot", desc: "Naturally sweet pumpkin, great for bhaji and soups.", descBn: "প্রাকৃতিকভাবে মিষ্টি কুমড়া, ভাজি ও স্যুপের জন্য দারুণ।" },
  { id: "spinach", category: "vegetables", name: "Spinach (Palong Shak)", nameBn: "পালং শাক", farmer: "Hasina Khatun", farmerId: "hasina", district: "Rangpur", price: 25, unit: "bunch", rating: 4.6, reviews: 58, icon: "leaf", desc: "Tender leafy spinach, harvested fresh every morning.", descBn: "প্রতিদিন সকালে তোলা কচি পালং শাক।" },
  ...
  { id: "jackfruit", category: "fruits", name: "Jackfruit (Kathal)", nameBn: "কাঁঠাল", farmer: "Salma Khatun", farmerId: "salma", district: "Chapainawabganj", price: 350, unit: "piece", rating: 4.3, reviews: 29, icon: "apple", desc: "The national fruit — sweet, ripe, and hand-picked.", descBn: "জাতীয় ফল — মিষ্টি, পাকা ও হাতে তোলা।" },
  { id: "lychee", category: "fruits", name: "Lychee (Litchi)", nameBn: "লিচু", farmer: "Salma Khatun", farmerId: "salma", district: "Chapainawabganj", price: 420, unit: "100pc", rating: 4.7, reviews: 88, icon: "apple", desc: "Juicy Dinajpur-variety lychee, in season.", descBn: "রসালো দিনাজপুরি জাতের লিচু, মৌসুমি।" },
  { id: "banana", category: "fruits", name: "Sagor Banana", nameBn: "সাগর কলা", farmer: "Hasina Khatun", farmerId: "hasina", district: "Rangpur", price: 60, unit: "dozen", rating: 4.5, reviews: 66, icon: "apple", desc: "Naturally ripened banana, no carbide used.", descBn: "প্রাকৃতিকভাবে পাকানো কলা, কোনো কার্বাইড ব্যবহার হয় না।" },
  ...
  { id: "yogurt", category: "dairy", name: "Traditional Doi", nameBn: "টক দই", farmer: "Jasim Uddin", farmerId: "jasim", district: "Pabna", price: 140, unit: "kg", rating: 4.9, reviews: 112, icon: "milk", desc: "Pabna-style clay-pot yogurt, thick and tangy.", descBn: "পাবনার মাটির পাত্রে তৈরি ঘন টক দই।" },
  ...
  { id: "litchi-honey", category: "honey", name: "Litchi Flower Honey", nameBn: "লিচু ফুলের মধু", farmer: "Salma Khatun", farmerId: "salma", district: "Chapainawabganj", price: 780, unit: "500g", rating: 4.7, reviews: 94, icon: "honey", desc: "Delicately floral honey from lychee orchard apiaries.", descBn: "লিচু বাগানের মৌচাক থেকে সংগৃহীত সুগন্ধি মধু।" },
];
